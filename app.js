...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Debug panel: flip DEBUG_MODE to true and the module self-injects
    if (DEBUG_MODE) {
        import('./debug/panel.js').then(({ initDebugPanel }) => {
...
// Debug panel UI functions moved to debug/panel.js
// Stubs for functions called from the enhanced model system when debug panel is absent
function updateModelsList() { window._debugUI?.updateModelsList(); }
function updateCurrentModelDisplay() { window._debugUI?.updateCurrentModelDisplay(); }
function updateUIFromParams() { window._debugUI?.syncUIFromParams(); }
...
// Slider tracking now handled by debug/panel.js when active
